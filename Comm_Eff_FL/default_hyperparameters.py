...
def get_hp_compression(compression):
  ...
  if c=="SignSGDErrorfeedbackwithstepaheadmomentum":
    return  {"compression_up" : ["SignSGDErrorfeedbackwithstepaheadmomentum", {}], "compression_down" : ["none", {}],
               "accumulation_up" : True, "accumulation_down" : False,  "aggregation" : "mean", "lr" : hp["lr"], "local_iterations" : 1}
  if c=="sgd":
    return  {"compression_up" : ["sgd", {}], "compression_down" : ["none", {}],
               "accumulation_up" : True, "accumulation_down" : False,  "aggregation" : "mean", "lr" : hp["lr"], "local_iterations" : 1}
  if c ==  "TopK" : 
    return  {"compression_up" : ["TopK", {}], "compression_down" : ["none", {}],
               "accumulation_up" : False, "accumulation_down" : False,  "aggregation" : "mean", "lr" : hp["lr"]}
  if c ==  "SignSGDwithmomentumwithoutTopk" : 
    return  {"compression_up" : ["SignSGDwithmomentumwithoutTopk", {}], "compression_down" : ["none", {}],
               "accumulation_up" : True, "accumulation_down" : False,  "aggregation" : "mean", "lr" : hp["lr"], "local_iterations" : 1}

  if c ==  "SignSGDwithmomentumTopk" : 
    return  {"compression_up" : ["SignSGDwithmomentumTopk", {}], "compression_down" : ["none", {}],
               "accumulation_up" : True, "accumulation_down" : False,  "aggregation" : "mean", "lr" : hp["lr"], "local_iterations" : 1}             
  if c ==  "SignSGDTopKErrorfeedbackwithstepaheadmomentum" : 
    return  {"compression_up" : ["SignSGDTopKErrorfeedbackwithstepaheadmomentum", {}], "compression_down" : ["none", {}],
               "accumulation_up" : False, "accumulation_down" : False,  "aggregation" : "mean", "lr" : hp["lr"]}             
