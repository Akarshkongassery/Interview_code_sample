...
def SignSGDwithmomentumwithoutTopk(T, hp):
    

  return T.sign()

def SignSGDErrorfeedbackwithstepaheadmomentum(T, hp):
...
def SignSGDTopKErrorfeedbackwithstepaheadmomentum(T,hp):
  hp_ = {'p' : 1.0, 'approx' : 1.0}
  hp_.update(hp)
...
def SignSGDwithmomentumTopk(T,hp):
  hp_ = {'p' : 1.0, 'approx' : 1.0}
  hp_.update(hp)
...
def get_bits(T, compression_method, approx=False):
  ...
  B_val = {"none" : 32, "sgd":1,"dgc" : 32, "stc" : 1, "SignSGDwithmomentumTopk":1,"SignSGDwithmomentumwithoutTopk" : 1,'SignSGDTopKErrorfeedbackwithstepaheadmomentum':1,"SignSGDErrorfeedbackwithstepaheadmomentum":1}[compression_method]

  # dense methods
  if compression_method in ["none","sgd", "SignSGDwithmomentumwithoutTopk","SignSGDErrorfeedbackwithstepaheadmomentum"]:
    k = T.numel()
    B_pos = 0
  ...
  elif compression_method in ["TopK","SignSGDTopKErrorfeedbackwithstepaheadmomentum",'SignSGDwithmomentumTopk']:
    k = torch.sum(T!=0.0).item()
    N = T.numel()
